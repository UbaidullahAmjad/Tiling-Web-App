...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/back/css/back_style.css') }}">
                        ...
                        <li class="nav-item dropdown hidden-caret">
                            ...
                            <ul class="dropdown-menu dropdown-user animated fadeIn">
                                ...
                                <li>
                                    ...
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item"
                                        href="{{ route('back.logout') }}">{{ __('Logout') }}</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-wrapper scrollbar-inner">
                <div class="sidebar-content">
                    ...
                    @php
                        //$appversion = 'Version 4.3';
                    @endphp
{{--                    <div class="sidebar-footer text-primary d-block text-center pt-3">--}}
{{--                        <span class="d-inline-block"><b>{{ $appversion }}</b></span>--}}
{{--                    </div>--}}
                </div>
            </div>
        </div>
