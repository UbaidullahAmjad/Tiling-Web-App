                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-group product-serch">
                                ...
                                <input type="text" required class="form-control" name="campaign_title"
                                    value="{{ $setting->campaign_title }}" placeholder="{{ __('Campaign Section Title') }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group product-serch">
                                <label for="name">{{ __('Campaign Last Date Time') }} *</label>
                                <input type="text" required class="form-control" name="campaign_end_date"
                                    value="{{ $setting->campaign_end_date }}" placeholder="{{ __('Enter Date') }}"
                                    id="datepicker">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group product-serch">
                                ...
                                <select name="campaign_status" class="form-control" id="campaign_status">
                                    <option value="1" {{ $setting->campaign_status == 1 ? 'selected' : '' }}>
                                        {{ __('Publish') }}</option>
                                    <option value="2" {{ $setting->campaign_status == 2 ? 'selected' : '' }}>
                                        {{ __('Unpublish') }}</option>
                                </select>
                            </div>
                        </div>
                            ...
                            @if ($items->count() > 0)
                                @foreach ($items as $data)
                                    <tr>
                                        ...
                                        <td> {{ App\Helpers\PriceHelper::adminCurrencyPrice($data->item->discount_price) }}
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                                <button
                                                ...
                                                <div class="dropdown-menu animated--fade-in"
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ route('back.campaign.status', [$data->id, 1, 'status']) }}">{{ __('Publish') }}</a>
                                                    <a class="dropdown-item"
                                                        href="{{ route('back.campaign.status', [$data->id, 0, 'status']) }}">{{ __('Unpublish') }}</a>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                                <button
                                                    class="btn btn-{{ $data->is_feature == 1 ? 'success' : 'danger' }} btn-sm  dropdown-toggle"
                                                    type="button" id="dropdownMenuButton" data-toggle="dropdown"
                                                    aria-haspopup="true" aria-expanded="false">
                                                ...
                                                <div class="dropdown-menu animated--fade-in"
                                                    aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item"
                                                        href="{{ route('back.campaign.status', [$data->id, 1, 'is_feature']) }}">{{ __('Active') }}</a>
                                                    <a class="dropdown-item"
                                                        href="{{ route('back.campaign.status', [$data->id, 0, 'is_feature']) }}">{{ __('Deactive') }}</a>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
