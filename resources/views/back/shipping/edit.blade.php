        ...
        <div class="card mb-4">
            <div class="card-body">
                <div class="d-sm-flex align-items-center justify-content-between">
                    ...
                    <a class="btn btn-primary btn-sm" href="{{ route('back.shipping.index') }}"><i
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span
                                                        class="input-group-text">{{ App\Helpers\PriceHelper::adminCurrency() }}</span>
                                                </div>
                                                <input type="text" id="price" name="minimum_price" class="form-control"
                                                    placeholder="{{ __('Enter Price') }}"
                                                    value="{{ App\Helpers\PriceHelper::setPrice($shipping->minimum_price) }}">
                                            </div>
                                            <label for="is_condition" class="text-left">
                                                <input type="checkbox" name="is_condition"
                                                    {{ $shipping->is_condition == 1 ? 'checked' : '' }}
                                                    class="my-2" id="is_condition">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" id="price" name="price" class="form-control"
                                                    placeholder="{{ __('Enter Price') }}"
                                                    value="{{ App\Helpers\PriceHelper::setPrice($shipping->price) }}">
                                            </div>
                                        </div>
                                    @endif
