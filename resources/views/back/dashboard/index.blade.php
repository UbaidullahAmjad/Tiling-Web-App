                ...
                <div class="card card-stats card-round">
                    <div class="card-body ">
                        <div class="row align-items-center">
                            ...
                            <div class="col col-stats ml-3 ml-sm-0">
                                <div class="numbers">
                                    <p class="mb-0"><b>Today's Product Order</b></p>
                ...
                <div class="card card-stats card-round">
                    <div class="card-body ">
                        <div class="row align-items-center">
                            ...
                            <div class="col col-stats ml-3 ml-sm-0">
                                <div class="numbers">
                                    <p class="mb-0"><b>This Month's Product Sale</b></p>
                ...
                <div class="card card-stats card-round">
                    <div class="card-body ">
                        <div class="row align-items-center">
                            ...
                            <div class="col col-stats ml-3 ml-sm-0">
                                <div class="numbers">
                                    <p class="mb-0"><b>This Year's Product Sale</b></p>
                ...
                <div class="card card-stats card-round">
                    <div class="card-body ">
                        <div class="row align-items-center">
                            ...
                            <div class="col col-stats ml-3 ml-sm-0">
                                <div class="numbers">
                                    <p class="mb-0"><b>Today's Pending Earning</b></p>
                ...
                <div class="card card-stats card-round">
                    <div class="card-body ">
                        <div class="row align-items-center">
                            ...
                            <div class="col col-stats ml-3 ml-sm-0">
                                <div class="numbers">
                                    <p class="mb-0"><b>This Month's Earning</b></p>
                ...
                <div class="card card-stats card-round">
                    <div class="card-body ">
                        <div class="row align-items-center">
                            ...
                            <div class="col col-stats ml-3 ml-sm-0">
                                <div class="numbers">
                                    <p class="mb-0"><b>This Year's Earning</b></p>
                        ...
                        <div class="card-body">
                            @if ($recentOrders->count() > 0)
                                <div class="gd-responsive-table">
                                    <table class="table table-bordered table-striped" id="recent-orders" width="100%"
                                        cellspacing="0">
                                        <thead>
                                            <th>{{ __('Customer') }}</th>
                                            <th>{{ __('Order ID') }}</th>
                                        ...
                                        <tbody>
                                            @foreach ($recentOrders as $data)
                                                <tr>
                                                    <td>
                                                        <a
                                                            href="{{ route('back.user.show', $data->user_id) }}">{{ $data->user->displayName() }}</a>
                                                    </td>
                                                    <td>
                                                        <a
                                                            href="{{ route('back.order.invoice', $data->id) }}">{{ $data->transaction_number }}</a>
                                                    </td>
                                                    <td>
                                                        {{ $data->payment_method }}
                                                    </td>
                                                    <td>
                                                        {{ $data->currency_sign }}{{ App\Helpers\PriceHelper::OrderTotal($data) }}
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
    ...
    <script>
        ...
        var myMultipleLineChart2 = new Chart(multipleLineChart2, {
            ...
            data: {
                labels: [{!! $earning_days !!}],
                datasets: [{
                    label: "Earning" + ' {{ App\Helpers\PriceHelper::adminCurrency() }}',
                    borderColor: "#f3545d",
                    pointBorderColor: "#FFF",
