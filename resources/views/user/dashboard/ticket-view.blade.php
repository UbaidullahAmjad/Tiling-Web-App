            ...
            <div class="mb-2">
                <div class="card">
                    <div class="card-body d-flex flex-row justify-content-between align-items-center">
                        ...
                        <div>
                        @if($ticket->file)
                        <a href="{{asset('assets/files/'.$ticket->file)}}" title="Download" class="btn btn-secondary btn-sm" download> {{__('Attachment')}}</a>
                        @endif
                        <a href="{{ route('user.ticket') }}" class="btn btn-secondary btn-sm">{{__('Back')}}</a>
                        </div>
