                        ...
                        <form  class="row" action="{{route('user.profile.update')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="avater" class="form-label">Image</label>
                                    <input class="form-control" style="padding-top:11.5px;"type="file" name="photo" id="avater">
                                @error('photo')
                            ...
                            <div class="col-12">
                                ...
                                <button class="btn btn-primary mt-2" type="submit"><span>{{__('Update Profile')}}</span></button>
                                </div>
                            </div>
                        </form>
                </div>
