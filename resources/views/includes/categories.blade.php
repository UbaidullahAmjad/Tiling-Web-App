    ...
    <div class="left-category-area">
        ...
        <div class="category-list">
            ...
            @foreach ($categories as $key => $pcategory)
                @if(count($pcategory->subcategory) > 0 )
                <div class="c-item">
                    ...
                    <div class="sub-c-box">
                            ...
                            <a class="title" href="{{route('front.catalog.products',$scategory->id)}}">
                                {{$scategory->name}}
            ...
            <div class="c-item text-center">
                    <span class="text-danger"><i class="fas fa-exclamation-triangle"></i> No Category Found</span>
                </div>
            @endif
