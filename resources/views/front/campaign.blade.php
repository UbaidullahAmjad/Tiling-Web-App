                            ...
                            ">
                                ...
                                @if ($compaign_item->previous_price && $compaign_item->previous_price != 0)
                                    <div class="product-badge product-badge2 bg-info">
                                        -{{ App\Helpers\PriceHelper::DiscountPercentage($compaign_item->item) }}</div>
                                @endif
                            ...
                            <div class="product-card-body">
                                ...
                                <h4 class="product-price">
                                    @if ($compaign_item->item->previous_price != 0)
                                        <del>{{ App\Helpers\PriceHelper::setPreviousPrice($compaign_item->item->previous_price) }}</del>
                                    @endif
                                    {{ App\Helpers\PriceHelper::grandCurrencyPrice($compaign_item->item) }}
                                </h4>
