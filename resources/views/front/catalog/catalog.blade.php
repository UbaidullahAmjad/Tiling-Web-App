                ...
                <div class="col-xxl-3 col-md-4 col-6">
                    <div class="product-card ">
                        ...
                        <div class="product-thumb">
                            <img class="lazy" src="{{ file_exists(public_path('assets/images/subcategory/' . $subcategory->navigation_img)) ? (asset('assets/images/subcategory/' . $subcategory->navigation_img)) : asset('assets/default/no-image.png')}}"
                                alt="Product">
