            ...
            <div class="col-xxl-3 col-md-4 col-6">
                    <div class="product-card ">
                        ...
                        <div class="product-thumb">
                            <img class="lazy" data-src="{{ asset('assets/images/products/'. $item->id . '/' . $item->photo) }}"
                                alt="Product" src="">
                        ...
                        <div class="product-card-body">
                            ...
                            <h3 class="product-title"><a href="{{ route('front.product', $item->slug) }}">{{$item->name}}
                                </a></h3>
                ...
                <div class="product-card product-list">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            <img class="lazy" data-src="{{ asset('assets/images/products/'. $item->id . '/' . $item->photo) }}"
                                 alt="Product" style="height: 150px;width: 150px" src="">
                        </div>
                        <div class="col-12 col-sm-6">
