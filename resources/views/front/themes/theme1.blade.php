                                ...
                                <div class="slider-item">
                                    <div class="product-card">
                                        <div class="product-thumb">
                                            ...
                                            @endif
                                            <img class="lazy"
                                                data-src="{{ file_exists(asset('assets/images/' . $popular_category_item->thumbnail)) ? asset('assets/images/' . $popular_category_item->thumbnail) : asset('assets/default/no-image.png') }}"
                                                alt="Product">
...
@if(count($feature_category_items)>0)
    @if ($setting->is_featured_category == 1)
        <section class="selected-product-section featured_cat_sec sps-two mt-50 mb-1">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title">
...
{{--                                    @endif--}}
                                    ...
                                    @endphp
                                    <p class="text-center"><img class="lazy"
                                        data-src="{{ file_exists(public_path($featureImage)) ? asset($featureImage) : asset('assets/default/no-image.png') }}"
                                        alt="Product" style="height:250px !important;width:100% !important;align-items:center !important"></p>
                                    <div class="product-button-group"><a class="product-button wishlist_store"
                                ...
                                <div class="slider-item">
                                    <a class="text-center"
                                        ...
                                        <img class="d-block hi-50 lazy"
                                            data-src="{{ file_exists(asset('assets/images/' . $brand->photo)) ? asset('assets/images/' . $brand->photo) : asset('assets/default/no-image.png') }} "
