...
class SubCategoryController extends Controller
{
    ...
    public function update(Request $request, Subcategory $subcategory)
    {
        $request->validate([
            ...
            'navigation_img' => 'mimes:jpeg,jpg,png'
        ]);
    ...
    /**
     * Remove gallery image from subcategory_galleries.
     *
     * @param  int  $id
     * @return \Illuminate\Http\Response
     */
    public function deleteGalleryImage(SubcategoryGallery $SubcategoryGallery)
    {
        $this->repository->galleryDelete($SubcategoryGallery);
