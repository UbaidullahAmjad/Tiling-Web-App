...
class HomePageController extends Controller
{
    ...
    public function popular_category_update(Request $request)
    {
        ...
        $data->update();
        return redirect()->back()->withSuccess(__('Popular Category Updated Successfully'));
    }
    ...
    public function tree_column_category_update(Request $request)
    {
        ...
        $data->update();
        return redirect()->back()->withSuccess(__('Tree Column Category Updated Successfully'));
    }
