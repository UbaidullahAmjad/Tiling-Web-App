...
class AccountController extends Controller
{
    ...
    public function billingSubmit(Request $request)
    {
        ...
        $input = $request->all();
        $user->update($input);
        Session::flash('success',__('Billing Address updated successfully'));
        return back();
    }
    ...
    public function shippingSubmit(Request $request)
    {
        ...
        $input = $request->all();
        $user->update($input);
        Session::flash('success',__('Shipping Address updated successfully'));
        return back();
    }
    ...
    public function removeAccount()
    {
        ...
        $user->delete();
        Session::flash('success',__('Your account successfully removed'));
